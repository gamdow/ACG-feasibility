...
// host stub function
void ops_par_loop_wave_block0_0_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(args, "wave_block0_0_kernel");
  #endif
  ...
  double * __restrict__ wk0 = (double *)(args[1].data + base1);
  ...
  #pragma omp simd aligned(phi,wk0)
  #else
  #pragma simd
  #endif
...
void ops_par_loop_wave_block0_0_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  desc->function = ops_par_loop_wave_block0_0_kernel_execute;
  if (OPS_diags > 1) {
