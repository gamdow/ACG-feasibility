...
// host stub function
void ops_par_loop_wave_block0_4_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(args, "wave_block0_4_kernel");
  #endif
  ...
  const double * __restrict__ phi = (double *)(args[0].data + base0);
  ...
  #pragma omp simd aligned(phi,phi_old)
  #else
  #pragma simd
  #endif
...
void ops_par_loop_wave_block0_4_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  desc->function = ops_par_loop_wave_block0_4_kernel_execute;
  if (OPS_diags > 1) {
