...
//
__constant__ int xdim0_wave_block0_0_kernel;
int xdim0_wave_block0_0_kernel_h = -1;
int ydim0_wave_block0_0_kernel_h = -1;
__constant__ int xdim1_wave_block0_0_kernel;
int xdim1_wave_block0_0_kernel_h = -1;
int ydim1_wave_block0_0_kernel_h = -1;
...
void wave_block0_0_kernel_gpu(const double *phi , double *wk0)
{
...
__global__ void ops_wave_block0_0_kernel(
...
int size0 ){
  ...
  if (idx_x < size0) {
    wave_block0_0_kernel_gpu(arg0, arg1);
  }
...
void ops_par_loop_wave_block0_0_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (xdim0 != xdim0_wave_block0_0_kernel_h || xdim1 != xdim1_wave_block0_0_kernel_h) {
    cudaMemcpyToSymbol( xdim0_wave_block0_0_kernel, &xdim0, sizeof(int) );
    xdim0_wave_block0_0_kernel_h = xdim0;
    cudaMemcpyToSymbol( xdim1_wave_block0_0_kernel, &xdim1, sizeof(int) );
  ...
  ops_wave_block0_0_kernel<<<grid, tblock >>> (  (double *)p_a[0], (double *)p_a[1],x_size);
