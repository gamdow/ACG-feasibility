...
//user function
void wave_block0_0_kernel(const __global double * restrict phi,__global double * restrict wk0,
  const double rc1,
const double rc2,
const double rc0,
...
__kernel void ops_wave_block0_0_kernel(
...
const int size0 ){
  ...
  if (idx_x < size0) {
    wave_block0_0_kernel(&arg0[base0 + idx_x * 1*1],
